...
Some lines are comments with what I write and look trought the course. Also I skipped the zkSync part. I also found out that for testing in the terminal the commands where slightly different than the ones shown in the videos. 

Best lessons learn: 
- AI helps a lot clarifying concepts and debugging errors.
- AI Copilot saves a lot of time of writing code, is cool to use it. 
- Pacience and be constant. 
